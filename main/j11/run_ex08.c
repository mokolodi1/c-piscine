...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2014/09/10 19:03:07 by tfleming          #+#    #+#             */
/*   Updated: 2014/09/10 19:15:52 by tfleming         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include		"../../j11/ex08/ft_list.h"
#include		<stdio.h>
...
int				main(void)
{
	...
	ft_list_reverse(&holder);
	printf("\nshould print in order opposite of pushed.\n");
	print_list(holder);
	return (0);
}

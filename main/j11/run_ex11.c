...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2014/09/10 21:33:42 by tfleming          #+#    #+#             */
/*   Updated: 2014/09/10 22:44:28 by tfleming         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include		"../../j11/ex11/ft_list.h"
#include		<stdio.h>
...
int				main(void)
{
	...
	printf("%s\n", (char*)ft_list_find(holder, "first pushed", &ft_strcmp)->data);
	printf("%s\n", (char*)ft_list_find(holder, "fifth pushed", &ft_strcmp)->data);
	return (0);
}

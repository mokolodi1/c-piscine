...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2014/09/10 20:24:41 by tfleming          #+#    #+#             */
/*   Updated: 2014/09/10 20:44:00 by tfleming         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include		"../../j11/ex10/ft_list.h"
#include		<stdio.h>
...
int				main(void)
{
	...
	printf("should print first pushed, then fifth\n");
	ft_list_foreach_if(holder, &print_it, "first pushed", &ft_strcmp);
	ft_list_foreach_if(holder, &print_it, "fifth pushed", &ft_strcmp);
	return (0);
}
